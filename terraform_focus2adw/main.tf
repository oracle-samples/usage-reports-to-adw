...
module "compute" {
    ...
    lb_application_url          = module.network.load_balancer_ip_address != null ? "https://${module.network.load_balancer_ip_address}/ords/r/focus/focus2adw" : "NA"
    lb_admin_url                = module.network.load_balancer_ip_address != null ? "https://${module.network.load_balancer_ip_address}/ords/r/apex/app-builder" : "NA"
}
...
output "APEX_Application_Login_URL" {
  value = replace(module.adb.apex_url,"apex","r/focus/focus2adw")
}

output "Load_Balancer_Apex_Admin_Workspace" {
  value = module.network.load_balancer_ip_address != null ? "https://${module.network.load_balancer_ip_address}/ords/r/apex/app-builder" : null
}

output "Load_Balancer_Apex_App_Login_URL" {
  value = module.network.load_balancer_ip_address != null ? "https://${module.network.load_balancer_ip_address}/ords/r/focus/focus2adw" : null
}
